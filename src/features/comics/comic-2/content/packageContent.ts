...
export const packageContent: ComicContentPackageLike = {
  ...
  application: {
    ...
    cards: [
      {
        id: 'komik2-application-relief-candi',
        title: 'Relief Candi',
        image: navReliefCandi.src,
        description: 'Relief Candi menunjukkan bentuk lingkaran yang simetris dan berulang.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Lingkaran',
      },
      {
        id: 'komik2-application-umpang',
        title: 'Umpang',
        image: navUmpang.src,
        description: 'Umpang memiliki bentuk persegi panjang yang rapi dan seimbang.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Persegi Panjang',
      },
      {
        id: 'komik2-application-atap-candi',
        title: 'Atap Candi',
        image: navAtapCandi.src,
        description: 'Atap Candi menunjukkan bentuk segitiga sama kaki yang simetris.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Segitiga Sama Kaki',
      },
      {
        id: 'komik2-application-relief-belah-ketupat',
        title: 'Relief Belah Ketupat',
        image: navPendopo.src,
        description: 'Relief belah ketupat menampilkan bentuk yang menyerupai belah ketupat.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Belah Ketupat',
      },
      {
        id: 'komik2-application-ornamen-persegi',
        title: 'Ornamen Persegi',
        image: navUmpang.src,
        description: 'Ornamen ini menampilkan bentuk persegi dengan sisi yang sama panjang.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Persegi',
      },
      {
        id: 'komik2-application-ornamen-segitiga-sama-sisi',
        title: 'Ornamen Segitiga Sama Sisi',
        image: navCandiInduk.src,
        description: 'Ornamen ini menunjukkan bentuk segitiga sama sisi yang seimbang.',
        options: ['Lingkaran', 'Persegi', 'Persegi Panjang', 'Segitiga Sama Kaki', 'Segitiga Sama Sisi', 'Belah Ketupat'],
        correctAnswer: 'Segitiga Sama Sisi',
      },
    ],
  },
  argumentation: {
